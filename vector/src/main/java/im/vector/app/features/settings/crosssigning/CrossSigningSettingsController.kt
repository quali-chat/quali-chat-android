        ...
        when {
            data.xSigningKeyCanSign -> {
                ...
                genericButtonItem {
                    ...
                    // textColor(host.colorProvider.getColor(im.vector.lib.ui.styles.R.color.base_color))
                    buttonClickAction {
            ...
            data.xSigningKeysAreTrusted -> {
                ...
                genericButtonItem {
                    id("Reset")
                    text(host.stringProvider.getString(CommonStrings.reset_cross_signing))
                    textColor(host.colorProvider.getColor(im.vector.lib.ui.styles.R.color.black_54))
                    buttonClickAction {
                        host.interactionListener?.didTapInitializeCrossSigning()
                    }
                }
